...
> 상태: 구현✅ 리뷰✅ 리팩토링· | 최종 갱신 2026-05-12
> plan: [spec](../../features/design-bundle-n-weight-chart-color/spec.md) · [design](../../features/design-bundle-n-weight-chart-color/design.md)
...
> 작성일: 2026-05-12
> 관련 스펙: [../features/design-bundle-n-weight-chart-color/spec.md](../../features/design-bundle-n-weight-chart-color/spec.md)
> 관련 구현: [../implementation/design-bundle-n-weight-chart-color-impl.md](#구현)
