...
| 순위 | Step | 내용 | 임팩트 | 난이도 | 의존성 | 상태 |
|------|------|------|--------|--------|--------|------|
| 10 | Step 10 | 히어로 카피 & 톤 리뉴얼 | 🔴 높음 | 낮 | 없음 | |
| 11 | Step 11 | SEO 메타 태그 브랜딩 | 🔴 높음 | 낮 | 없음 | |
| 12 | Step 12 | 온보딩 톤 변경 | 🟡 중간 | 낮 | Step 1 완료 필요 | |
| 13 | Step 13 | About → "만든 사람" 스토리텔링 | 🟡 중간 | 중 | Step 10 (BRAND_COPY 필요) | |
| 14 | Step 14 | 아티클 authorNote | 🟡 중간 | 중 | 없음 | |
| 15 | Step 15 | Contact 톤 변경 | 🟢 낮음 | 낮 | 없음 | |

### 콘텐츠 강화: 타임라인 & 베이비페어 (Step 16~17)

| 순위 | Step | 내용 | 임팩트 | 난이도 | 의존성 | 상태 |
|------|------|------|--------|--------|--------|------|
| 16 | Step 16 | 타임라인 정보 구체화 (빈 주차 채우기, type 배지) | 🔴 높음 | 중 | 없음 | |
| 17 | Step 17 | 베이비페어 정보 구체화 (확장 필드, UI 보강) | 🟡 중간 | 중 | Step 6 완료 권장 | |
...
| Week 1 | Step 10: 히어로 카피 변경 + BRAND_COPY 상수 | 병렬, 10분 |
| Week 1 | Step 11: SEO 메타 태그 | 병렬, 10분 |
| Week 1 | Step 15: Contact 톤 변경 | 병렬, 10분 |
| **Week 2 (4/14~4/18)** | Step 12: 온보딩 톤 변경 | Step 10 이후 |
| Week 2 | Step 13: About 스토리텔링 리뉴얼 | Step 10 이후 |
| Week 2 | Step 16: 타임라인 빈 주차 채우기 + type 배지 | 독립 작업 |
| **Week 3 (4/21~4/25)** | Step 5: 크로스 링크 | 데이터 변경 포함 |
| Week 3 | Step 14: 아티클 authorNote | 병렬 |
| Week 3 | Step 7: 체중관리 접근성 | Step 3 완료 후 |
| **Week 4 (4/28~5/2)** | Step 17: 베이비페어 정보 구체화 | Step 6 완료 후 |
| Week 4 | Step 9: 달성감/마일스톤 | 선택 사항 포함 |
| **Week 5 (5/5~5/9)** | E2E 테스트 업데이트 | 전체 변경분 |
| 5/12~5/15 | QA + 배포 | |
