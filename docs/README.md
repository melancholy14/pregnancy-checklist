...
| 페르소나별 시각 | [marketing/persona.md](marketing/persona.md) · [design/persona.md](design/persona.md) · [content/persona.md](content/persona.md) | 도메인 결정 |
...
새 문서는 위 5개 위치 중 하나로 들어가야 함. 페르소나 축이 있으면 해당 폴더, 없으면 `plan/`.
