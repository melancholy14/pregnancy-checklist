...
| ~~**P10**~~ | ✅ **완료 (2026-07-30)** — [ops/operator-guide.md](../ops/operator-guide.md) 발행 (§1 데이터 변경 룰 + §2 신규 글 SOP + §3 AI 이미지 SOP 합본, image-sop.md 흡수) | 체크리스트 데이터 변경 사고 예방, 신규 글 작성 SOP, AI 이미지 SOP 합본 | ~~F1·F4 진입 전 작성~~ 완료 |
...
3. ~~**운영자 가이드 통합**: P10 통합 본체 작성~~ ✅ 완료 (2026-07-30, [ops/operator-guide.md](../ops/operator-guide.md)) — sweep에서 제외
