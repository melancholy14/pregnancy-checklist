...
> **진행 현황 (2026-05-20 기준): 6/9 발행 완료** — 국민행복카드(5/01)·금지 음식(5/02)·영양제(5/03)·운동(5/05)·산후조리원(5/09)·베이비페어(5/17) 발행 / 3개 미작성(기형아 검사·임신성 당뇨·수면).

| 순번 | 제목 (안) | 타겟 키워드 | 경험 근거 | 영상 크로스링크 | 발행 상태 |
|------|----------|-----------|----------|--------------|----------|
| 1 | 임산부 영양제 복용 가이드 — 엽산·철분·오메가3 주차별 정리 | 임산부 영양제, 엽산 언제까지 | 6주부터 현재까지 복용 중 | video_049~051 | ✅ 2026-05-03 (`pregnancy-supplements-by-week.md`) |
| 2 | 임신 중 금지 음식·주의 음식 정리 | 임산부 금지 음식, 임신 중 커피 | 일상에서 계속 체크 | video_052~054 | ✅ 2026-05-02 (`pregnancy-foods-to-avoid.md`) |
| 3 | 기형아 검사 종류와 일정 — NIPT·통합선별·쿼드·정밀초음파 경험기 | 기형아 검사, NIPT 검사 | 9~20주 검사 완료 | video_040~045 | ⬜ 미작성 |
| 4 | 임산부 운동 시작 가이드 — 뭘 하면 되고 뭘 하면 안 되나 | 임산부 운동, 임산부 요가 | 21주부터 운동 시작 | video_001~010 | ✅ 2026-05-05 (`pregnancy-exercise-starter-guide.md`) |
| 5 | 국민행복카드·정부 지원 혜택 총정리 (2026) | 국민행복카드, 임산부 혜택 2026 | 10주에 발급 | video_058 | ✅ 2026-05-01 (`pregnancy-government-benefits-2026.md`) |
| 6 | 임신성 당뇨 검사 후기 — 검사 과정과 결과 대처법 | 임신성 당뇨 검사, GDM | 24주 전후 검사 | video_037~039 | ⬜ 미작성 |
| 7 | 산후조리원 선택 가이드 — 비교 기준과 예약 타이밍 | 산후조리원 선택, 산후조리원 비용 | 12주에 예약 완료 | — | ✅ 2026-05-09 (`postpartum-care-center-guide.md`) |
| 8 | 임산부 수면 자세와 숙면 팁 | 임산부 수면, 임산부 잠자는 자세 | 중기부터 수면 불편 경험 중 | — | ⬜ 미작성 |
| 9 | 베이비페어 200% 활용법 — 가기 전 준비부터 현장 팁까지 | 베이비페어 꿀팁, 베이비페어 준비 | 18주에 방문 | 베이비페어 페이지 연동 | ✅ 2026-05-17 (`babyfair-survival-guide.md`) |

**추천 작성 순서** (검색량 + 작성 난이도):
~~금지 음식~~ ✅ → ~~영양제~~ ✅ → 기형아 검사 → ~~국민행복카드~~ ✅ → 임신성 당뇨 → ~~운동~~ ✅ → ~~산후조리원~~ ✅ → 수면 → ~~베이비페어~~ ✅

> 참고: 9개 표 외에 `mid-pregnancy-lifestyle-guide.md`(2026-04-29)도 별도 신규 발행됨.
