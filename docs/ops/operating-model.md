...
- **graphify** — Next.js 모노레포(50x 절약 사례)와 PoC 규모(< 100파일) ROI 차이가 superlinear. PoC 규모에서는 셋업 비용 + graph staleness 비용 > 절약 토큰. `docs/implementation/<name>-impl.md`가 사실상 수동 knowledge graph 역할 중.
