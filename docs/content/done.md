...
| **AdSense 상태** | 인프라(스크립트·AdUnit·ads.txt·쿠키 동의) 완비 — Phase 3에서 마감 |
...
| 1.5 | 2026-04-04 | 타임라인↔체크리스트 통합, AdSense 기초 |
| 2 | 2026-04-04 | YouTube 세분화, 정보성 글 시스템, AdSense 신청 |
| 2.5 | 2026-04-13 | 온보딩, 홈 대시보드 개편, "초산 개발자" 톤, 타임라인 정보 구체화 |
| 3 | 2026-05-01 | AdSense 인프라 마감, YMYL 보강, GA4 누락 이벤트, 검색, Lighthouse SEO |
