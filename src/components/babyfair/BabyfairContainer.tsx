  ...
  return (
    <div className="min-h-screen pb-24 px-4">
      <div className="max-w-4xl mx-auto pt-8">
        ...
        {/* Info Card */}
        <Card className="mt-8 rounded-2xl shadow-md border border-black/4 bg-linear-to-r from-[#F0C8D2]/40 to-[#D4C4E4]/40">
          <CardContent className="p-6">
            <h3 className="mb-3">참관 팁</h3>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                <span className="w-1 h-1 rounded-full bg-[#F0C8D2] mt-2 shrink-0" />
                사전 등록하면 입장료 할인 혜택이 있어요
              </li>
              <li className="flex items-start gap-2">
                <span className="w-1 h-1 rounded-full bg-[#D4C4E4] mt-2 shrink-0" />
                카드 여러 개 준비하면 카드사 할인 받을 수 있어요
              </li>
              <li className="flex items-start gap-2">
                <span className="w-1 h-1 rounded-full bg-[#C0DCD0] mt-2 shrink-0" />
                오전 일찍 가면 인기 상품 선착순 혜택을 받을 수 있어요
              </li>
              <li className="flex items-start gap-2">
                <span className="w-1 h-1 rounded-full bg-[#ECD2BE] mt-2 shrink-0" />
                큰 에코백이나 카트 챙겨가세요
              </li>
              <li className="flex items-start gap-2">
                <span className="w-1 h-1 rounded-full bg-[#E8E2C6] mt-2 shrink-0" />
                편한 신발 필수! 많이 걸어야 해요
              </li>
            </ul>
          </CardContent>
