...
export default function TimelinePage() {
  ...
  const _baseItems = timelineItems as TimelineItem[];
        ...
        <div className="relative">
          ...
          <div className="space-y-8">
            {milestones.map((milestone) => {
              ...
              const isCurrent = currentWeek != null && currentWeek >= milestone.week - 2 && currentWeek <= milestone.week + 2;
              ...
              return (
                <div key={milestone.week} className="relative pl-20">
                  ...
                  <Card
                    ...
                    style={isCurrent ? { "--tw-ring-color": milestone.color } as React.CSSProperties : {}}
                  >
