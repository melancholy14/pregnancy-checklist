...
import data from "@/data/pregnancy_prep_checklist.json";
...
export default function PregnancyPrepChecklistPage() {
  ...
  return (
    <>
      <BreadcrumbJsonLd items={getBreadcrumbForPath("/checklist/pregnancy-prep")} />
      <ChecklistPage
        data={checklistData}
        storeSlug="pregnancy-prep"
