...
import data from "@/data/partner_prep_checklist.json";
...
export default function PartnerPrepChecklistPage() {
  ...
  return (
    <>
      <BreadcrumbJsonLd items={getBreadcrumbForPath("/checklist/partner-prep")} />
      <ChecklistPage
        data={checklistData}
        storeSlug="partner-prep"
